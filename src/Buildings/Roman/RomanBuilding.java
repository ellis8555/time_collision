...
public class RomanBuilding extends BuildingDesign {
    ...
    public RomanBuilding(String name, int realmBuildingBelongsTo){
    ...
    public RomanBuilding(String name, int owner, int realmBuildingBelongsTo){
    ...
    public RomanBuilding(int owner, int realmBuildingBelongsTo){
